...
public class Controller : MonoBehaviour
{
    ...
    // Solar calender
    [SerializeField] TextMeshProUGUI solarDate;
    [SerializeField] TextMeshProUGUI solarTime;
    [SerializeField] TextMeshProUGUI solarTimeSuffix;
    ...
    [SerializeField] TextMeshProUGUI lunarTimeSuffix;
    ...
    public void UpdateSolarTime(DateTime date)
    {
        solarDate.text = date.DayOfWeek.ToString() + ", " + months[date.Month-1] + " " + date.Day + ", " + date.Year;
    ...
    public void UpdateLunarTime(DateTime date)
    {
        ...
        lunarDate.text = date.DayOfWeek.ToString() + ", " + months[lunar.lunarMonth - 1] + " " + lunar.lunarDay + ", " + lunar.lunarYear;
        lunarTime.text = solarTime.text;
        lunarTimeSuffix.text = date.ToString("tt");
        lunarTimeRegion.text = TimeZoneInfo.Local.ToString();
    }
    ...
    public string GetDoubleTimeString(int value)
    {
